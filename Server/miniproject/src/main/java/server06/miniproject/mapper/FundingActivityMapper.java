...
public interface FundingActivityMapper {
	...
	int insertFundingAvtivity(@Param("fund_act_id") int fund_act_id , @Param("fund_id") int fund_id, @Param("mem_id") int mem_id, @Param("point") int point, @Param("funddate") Date funddate);
}
