...
public interface FundingMapper {
	...
	int insertFunding(@Param("fund_id") String fund_id , @Param("fund_inst") String fund_inst, @Param("inst_icon") String inst_icon, @Param("inst_des") String inst_des, @Param("tar_point") int tar_point, @Param("acu_point") int acu_point);
	...
	int updateFunding(@Param("fund_id") String fund_id , @Param("fund_inst") String fund_inst, @Param("inst_icon") String inst_icon, @Param("inst_des") String inst_des, @Param("tar_point") int tar_point, @Param("acu_point") int acu_point);
